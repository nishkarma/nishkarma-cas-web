...
<br />
<a href="${MyGoogle2ClientUrl}">Authenticate with Google+</a><br />
<br />
<a href="${NaverClientUrl}">Authenticate with Naver</a><br />
<br />
<a href="${KakaoClientUrl}">Authenticate with Kakao</a><br />
<br />
